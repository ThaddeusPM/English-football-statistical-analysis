        ...
        <header className="mb-12">
          <div className="flex items-center justify-between border-b border-slate-700 pb-6 mb-6">
            ...
            <div className="flex items-center bg-purple-900/30 rounded-full px-4 py-2">
              ...
              <span className="text-purple-400 font-medium">Google Gemini Analysis</span>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-3 mb-4">
            ...
            <span className="bg-blue-900/30 text-purple-400 px-3 py-1 rounded-full text-sm">Google Gemini Advanced deep research</span>
          </div>
          <p className="text-slate-300 text-lg">
            Comprehensive match analysis powered by Gemini
          </p>
        </header>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="group/stat">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-medium text-slate-300 group-hover/stat:text-green-400 transition-colors">45%</span>
                  </div>
                  <div className="h-1.5 w-full bg-slate-700/50 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-green-600 to-green-400 rounded-full" style={{ width: '45%' }}></div>
                  </div>
                </div>
                ...
                <div className="group/stat">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-medium text-slate-300 group-hover/stat:text-blue-400 transition-colors">30%</span>
                  </div>
                  <div className="h-1.5 w-full bg-slate-700/50 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-blue-600 to-blue-400 rounded-full" style={{ width: '30%' }}></div>
                  </div>
                </div>
                ...
                <div className="group/stat">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="font-medium text-slate-300 group-hover/stat:text-slate-300 transition-colors">25%</span>
                  </div>
                  <div className="h-1.5 w-full bg-slate-700/50 rounded-full overflow-hidden">
                    <div className="h-full bg-gradient-to-r from-slate-600 to-slate-400 rounded-full" style={{ width: '25%' }}></div>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center pt-3 mt-3 border-t border-slate-700/50">
                  ...
                  <span className="font-medium px-3 py-1 bg-green-500/10 text-green-400 rounded-md border border-green-500/20">1-1</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="relative z-10 p-6">
              ...
              <div className="mt-5 pt-5 border-t border-slate-700/50">
                <div className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-slate-400">Analysis based on vibes and the blood, sweat, and tears of gemini</span>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="group relative overflow-hidden p-4 bg-gradient-to-br from-red-900/30 to-red-800/10 rounded-lg border border-red-900/30 shadow-sm hover:border-red-500/30 transition-all duration-300">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center">
                        <div className="text-2xl font-bold text-red-400 mr-3 group-hover:text-red-300 transition-colors">45%</div>
                        <div className="h-2 w-full bg-slate-700/50 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-red-800 to-red-500 rounded-full" style={{ width: '45%' }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden p-4 bg-gradient-to-br from-blue-900/30 to-blue-800/10 rounded-lg border border-blue-900/30 shadow-sm hover:border-blue-500/30 transition-all duration-300">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center">
                        <div className="text-2xl font-bold text-blue-400 mr-3 group-hover:text-blue-300 transition-colors">30%</div>
                        <div className="h-2 w-full bg-slate-700/50 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-blue-800 to-blue-500 rounded-full" style={{ width: '30%' }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="group relative overflow-hidden p-4 bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-lg border border-slate-700/50 shadow-sm hover:border-slate-500/50 transition-all duration-300">
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center">
                        <div className="text-2xl font-bold text-slate-400 mr-3 group-hover:text-slate-300 transition-colors">25%</div>
                        <div className="h-2 w-full bg-slate-700/50 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-slate-600 to-slate-400 rounded-full" style={{ width: '25%' }}></div>
                        </div>
                      </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="mb-3">
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <div className="text-green-400 font-medium">1.2-1.4</div>
                        </div>
                        <div className="h-2 w-full bg-slate-700/50 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-red-800 to-red-500 rounded-full" style={{ width: '50%' }}></div>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="h-2 w-full bg-slate-700/50 rounded-full overflow-hidden">
                          <div className="h-full bg-gradient-to-r from-slate-600 to-slate-400 rounded-full" style={{ width: '50%' }}></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-br from-slate-800/50 to-slate-700/30 border border-slate-700/30 rounded-lg text-slate-400 font-bold group-hover:border-slate-500/30 transition-all duration-300">1</div>
                        </div>
                        <div className="flex flex-col items-end">
                          <div className="text-2xl font-bold text-purple-400 group-hover:text-purple-300 transition-colors">15%</div>
            ...
            <div className="relative z-10 p-8">
                ...
                <div className="p-4 bg-slate-800/50 rounded-lg border border-slate-700/50 mb-4">
                  <div className="flex flex-col space-y-2">
                    <div className="flex items-center">
                      ...
                      <span className="ml-auto text-green-400">1.2-1.4</span>
                    </div>
                    <div className="flex items-center">
              ...
              <div className="mt-8 pt-6 border-t border-slate-700/30">
                <button className="flex items-center text-sm bg-blue-900/20 border border-blue-900/30 text-blue-400 px-3 py-1.5 rounded-lg hover:bg-blue-900/30 transition-colors">
                  ...
                  Additional details to follow... if I feel like it
                </button>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12">
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            ...
            <div className="bg-white rounded-lg p-3">
              {/* PDF Embedded Viewer */}
              <object 
                data="/wrexham-vs-exeter-gemini.pdf#toolbar=1&navpanes=0&scrollbar=1&view=FitH"
          ...
          <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700">
            ...
            <div className="flex items-center mt-6">
              ...
              <div>
                ...
                <p className="text-purple-400 font-medium">Google Gemini Advanced Deep Research</p>
              </div>
            </div>
          </div>
        </section>
...
export default GeminiAnalysisPage;